...
$query =mysqli_query($con,"UPDATE berita set  judul_berita='$judul',  isi_berita='$isi', id_kategori='$kategori', gambar_berita='$gambar', status_berita='$status_berita' where id_berita = '$id'" );
