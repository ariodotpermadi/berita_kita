...
?>
  ...
  <?php
    $query=mysqli_query($con, "SELECT * FROM berita ORDER BY id_berita  DESC LIMIT 7");
  ...
  <!--Tag-->
  <div class="aside">
  <div style="margin:40px 0 0 860px ; width:100%; height:100%; ">
  <h4><strong>Tag Berita</strong></h4>
  <hr style="border:2px solid red; width:23%; margin:0 0 0 0; "><br>
    
  <?php
  $query=mysqli_query($con, "SELECT * FROM tag_tag LEFT JOIN kategori ON tag_tag.id_kategori=kategori.id_kategori");
  
  ?>
  

  <button class="btn btn-primary btn-xs"><a href="#">#support</a></button>
  </div><!--End Tag-->



  <!--Isi berita-->
    <div style="margin: -240px 0 0 60px; width:700px; height:max-content">
...
<!--Kolom Komentar-->
<div style="margin: -40px 0 0 -60px; width:fit-content">
<hr class="hr-bottom2">
